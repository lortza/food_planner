...
RSpec.describe "ShoppingListItemStatusesController", type: :request do
  ...
  describe "unauthenticated access" do
    ...
    it "denies access to #activate" do
      post activate_shopping_list_item_path(item)
    ...
    it "denies access to #deactivate" do
      post deactivate_shopping_list_item_path(item)
    ...
    it "denies access to #activate_from_search" do
      post activate_from_search_shopping_list_item_path(item)
    ...
    it "denies access to #add_to_cart" do
      post add_to_cart_shopping_list_item_path(item)
    ...
    it "denies access to #remove_from_cart" do
      post remove_from_cart_shopping_list_item_path(item)
  ...
  describe "authenticated access" do
    ...
    describe "POST #activate" do
      context "when item is inactive" do
        ...
        it "sets the item status to active" do
          post activate_shopping_list_item_path(item), headers: turbo_stream_headers
    ...
    describe "POST #deactivate" do
      ...
      it "sets the item status to inactive" do
        post deactivate_shopping_list_item_path(item), headers: turbo_stream_headers
    ...
    describe "POST #add_to_cart" do
      ...
      it "sets the item status to in_cart" do
        post add_to_cart_shopping_list_item_path(item), headers: turbo_stream_headers
    ...
    describe "POST #remove_from_cart" do
      ...
      it "sets the item status to active" do
        post remove_from_cart_shopping_list_item_path(item), headers: turbo_stream_headers
    ...
    describe "POST #deactivate_all_items" do
      ...
      it "sets all items on the list to inactive" do
        post deactivate_all_items_shopping_list_path(shopping_list)
