...
- Recipe Organization
  ...
  - Flexible recipe creation. Create a recipe from scratch, but copy/pasting text into a simple body field for AI parsing, or via a single source url for AI parsing ([PR #1115](https://github.com/lortza/food_planner/pull/1115))
