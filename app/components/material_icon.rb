...
class MaterialIcon
  ...
  def add_shopping_cart
    content_tag(:span, "add_shopping_cart",
      ...
      alt: @title.presence || "Add to cart",
  ...
  def plus_square
    content_tag(:span, "add_box",
      class: symbol_classes,
      alt: @title.presence || "Add to list",
  ...
  def shopping_bag
    content_tag(:span, "shopping_bag",
      class: icon_classes,
      alt: @title.presence || "In shopping bag",
